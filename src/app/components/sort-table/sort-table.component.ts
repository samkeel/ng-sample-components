...
export class SortTableComponent {
  @Input() public tableData: any[] = [
    { first: 'Sam 1', age:'20', living: false , dob: '05/09/84' },
    { first: 'Sam 2', age:'32', living: false , dob: '05/09/84' },
    { first: 'Sam 3', age:'37', living: true , dob: '05/09/84' },
    { first: 'Sam 4', age:'56', living: false , dob: '05/09/84' },
  ];
